...
Das Kodierungstheorem von Levin besagt, ein binäres Wort ist desto einfacher, je größer seine algorithmische Wahrscheinlichkeit ist, nämlich $$K_{T_U}(w)=-\log_2AP(w)+O(1)$$ [5]. Gemäß dieser Gleichung konzipierten Delahaye und Zenil ein Näherungsverfahren für $$AP(w)$$ [6]. Sie erzielten dies dadurch, dass sie eine Menge von 11019960576 2-Symbole-Turingmaschinen berechneten, um die Erzeugungsverteilung aller unterschiedlichen Wörter der Länge $$1\textless |w|\textless 8$$ zu rekonstruieren.
